...
Suggestions for new entries may be submitted by [creating a new issue](https://github.com/tmedwards/.sugarcube/sugarcube-2-37-3/issues) at SugarCube's [source code repository](https://github.com/tmedwards/.sugarcube/sugarcube-2-37-3).
